...
import EachThumbnail from './Components/EachThumbnail'
...
class App extends Component {
  ...
  tick = () => {
    ...
    if (time !== 0) {
      ...
      this.setState(
        prevState => ({imagesView: !prevState.imagesView}),
        this.timer,
      )
    }
  }
  ...
  updateImage = imageUrl => {
    ...
    if (matchImage === imageUrl) {
      this.setState(
        prevState => ({
          count: prevState.count + 1,
          matchImage: imagesList[index].imageUrl,
        }),
  ...
  getScoreCard = () => {
    ...
    return (
      <div className="score-card-container">
        ...
        <button
          type="button"
          className="button play-again-container"
  ...
  getImagesSection = () => {
    const {matchImage, activeTabId} = this.state
        ...
        <div className="first-container">
          ...
          <div className="score-time-container">
            <div className="score-container">
              ...
              <p className="timer-span">{count}</p>
            </div>
            <div className="score-container">
              <img
                ...
                className="timer"
              />
              <p className="timer-span">{time} sec</p>
            </div>
          </div>
        </div>
        <div className="second-container">{this.resultView()}</div>
      </div>
    )
  }
}
